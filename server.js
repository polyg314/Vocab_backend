...
router.get('/', (req, res) => {
    res.status(200).send('Can I help you?');
});
...
const  dropDictionaryTable = () => {
    const  sqlQuery3 =  `
        DROP TABLE user_dictionary;`
    return database.run(sqlQuery3);
}
...
//     console.log(dictionary)
//     console.log(req.body);
//     database.run('INSERT INTO user_dictionary 
//         (user_id,
//         dictionary) 
//         VALUES
//         (
